      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            ?>
            <ul>
              <li <?php if(is_page('about-us') || wp_get_post_parent_id() == 14) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us') ?>">About Us</a></li>
              <li <?php if(get_post_type() == 'program' || is_page('programs')) echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('program'); ?>">Programs</a></li>
          ...
          <div class="site-header__util">
            ...
            ?>
              ...
              <a href="<?php echo wp_logout_url() ?>" class="btn btn--small btn--dark-orange float-left btn--with-photo">
                <span calss="site-header__avatar"><?php echo get_avatar(get_current_user_id(), 20); ?></span>
